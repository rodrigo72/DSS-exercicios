...
import uminho.dss.turmas3l.data.SalaDAO;
...
public class TurmasFacade implements ITurmasFacade {
    ...
    @Override
    public void adicionaSala (Sala s) {this.salas.put(s.getNumero(), s); }
     ...
     */
    @Override
    public boolean alteraSalaDeTurma(String tid, Sala s) {
        if (salas.containsKey(s.getNumero())) {
    ...
    public boolean existeSala (String num) {
        return this.salas.containsKey(num);
    }
